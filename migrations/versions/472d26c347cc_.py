...
Revision ID: 472d26c347cc
Revises: 
Create Date: 2023-09-11 04:28:59.050907
...
def upgrade():
    ...
    sa.Column('exercise_question_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['exercise_question_id'], ['exercise_questions.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
